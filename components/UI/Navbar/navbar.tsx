...
export default function Navbar() {
  ...
  return (
    ...
    <div className="h-24 items-center flex px-8">
      {/* Mobile menu button - ahora a la izquierda */}
      <div className='lg:hidden cursor-pointer py-6 mr-4'>
              ...
              <menu>
                ...
                <li className='py-4'>
                  <div className="flex items-center">
                    <span className="text-white text-lg mr-4">{t('navbar.languageSelector')}</span>
                    <LanguageSelector />
                  </div>
                </li>
                <li className='border-b border-gray-600'></li>
      ...
      {/* Botón usuario y búsqueda - más pegados al mobile menu */}
      <div className="flex items-center space-x-3 lg:hidden">
        ...
        <div className="relative flex items-center">
          <div className={`overflow-hidden transition-all duration-300 ease-in-out ${
            ...
            <form onSubmit={handleSearch}>
              <input
                ...
                type="search"
                id="default-search"
                className="bg-transparent block w-full p-3 pl-10 text-sm text-cream border border-gray-600 rounded-[30px] transition-all duration-300 outline-none placeholder-gray-400 hover:bg-transparent focus:bg-transparent"
          ...
          <button 
            ...
            className="relative text-cream hover:text-white pl-2 transition-all duration-300"
          >
            <svg
      ...
      {/* Contenedor para desktop - botón usuario, búsqueda, idiomas y logo */}
