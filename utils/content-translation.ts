...
const ROUTINE_TRANSLATIONS: Record<string, { en: string; es: string }> = {
  ...
  'FULL BODY #8': { en: 'FULL BODY #8', es: 'CUERPO COMPLETO #8' },
  'ABS #9': { en: 'ABS #9', es: 'ABDOMINALES #9' },
  'UPPER BODY #10': { en: 'UPPER BODY #10', es: 'TREN SUPERIOR #10' },
  'MOBILITY #11': { en: 'MOBILITY #11', es: 'MOVILIDAD #11' },
  'CARDIO #12': { en: 'CARDIO #12', es: 'CARDIO #12' },
  'MOBILITY #13': { en: 'MOBILITY #13', es: 'MOVILIDAD #13' },
  'MOBILITY #15': { en: 'MOBILITY #15', es: 'MOVILIDAD #15' },
  'ABS #16': { en: 'ABS #16', es: 'ABDOMINALES #16' },
  'LOWER BODY #17': { en: 'LOWER BODY #17', es: 'TREN INFERIOR #17' },
  'COMBO #18': { en: 'COMBO #18', es: 'COMBO #18' },
  'GLUTE, LEGS #19': { en: 'GLUTE, LEGS #19', es: 'GLÚTEOS, PIERNAS #19' },
  'MOBILITY #20': { en: 'MOBILITY #20', es: 'MOVILIDAD #20' },
  'ABS #22': { en: 'ABS #22', es: 'ABDOMINALES #22' },
  'FULL BODY #23': { en: 'FULL BODY #23', es: 'CUERPO COMPLETO #23' },
  'GLUTE, LEGS #24': { en: 'GLUTE, LEGS #24', es: 'GLÚTEOS, PIERNAS #24' },
  'FULL BODY #25': { en: 'FULL BODY #25', es: 'CUERPO COMPLETO #25' },
  'UPPER BODY #26': { en: 'UPPER BODY #26', es: 'TREN SUPERIOR #26' },
  'MOBILITY #27': { en: 'MOBILITY #27', es: 'MOVILIDAD #27' },
