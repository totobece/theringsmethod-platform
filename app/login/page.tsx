        ...
        <div className="w-full space-y-10 p-8 rounded-2xl bg-darkgrad border-2 border-gray-600">
          ...
          >
            <div className="flex flex-col">
              <label className="text-white text-xl font-medium" htmlFor="email">{t('auth.email')}:</label>
              <input
                id="email"
                name="email"
                type="email"
            ...
            <div className="flex flex-col">
              <label className="text-white text-xl font-medium" htmlFor="password">{t('auth.password')}:</label>
              <input
                id="password"
                name="password"
            ...
            <div className="cursor-pointer hover:underline  flex justify-end " onClick={() => setShowPassword(!showPassword)}>
              <p className="text-md text-white">{showPassword ? t('auth.hidePassword') : t('auth.showPassword')}</p>
            </div>
