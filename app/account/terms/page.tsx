...
If you do not wish to be bound by these Terms, you may not access or use the pliability Service. Certain elements of the pliability Service may be subject to additional terms and conditions specified from time to time; your use of those elements of the pliability Service is subject to those additional terms and conditions, which are incorporated into these Terms by this reference.

The User must read this document carefully.

TERMS OF USE
Unless otherwise specified, the terms of use detailed in this section apply generally when using this Service. Single or additional conditions of use or access may apply in specific scenarios and in such cases are additionally indicated within this document. By using this Service, Users confirm to meet the following requirements:

‍

Eligibility Requirements
Membership Age Requirement. You must be at least 18 years old, or the age of legal majority in your jurisdiction of residence, to purchase a pliability membership subscription and become a member.

pliability may, in its sole discretion, refuse to offer the pliability Service to any person or entity and change the eligibility criteria at any time. You are solely responsible for ensuring that these Terms are in compliance with all laws, rules and regulations applicable to you, and the right to access and use the pliability Service is revoked where these Terms or use of the pliability Service is prohibited or conflicts with any applicable law, rule or regulation. Further, the pliability Service is offered only for your personal, non-commercial use, and not for the use or benefit of any third party.

‍

Content on This Application
Unless where otherwise specified or clearly recognizable, all content available on this Application is owned or provided by pliability or its licensors. pliability undertakes its utmost effort to ensure that the content provided on this Application infringes no applicable legal provisions or third-party rights. However, it may not always be possible to achieve such a result. In such cases, without prejudice to any legal prerogatives of Users to enforce their rights, Users are kindly asked to preferably report related complaints using the contact details provided in this document.

‍

License to Use the pliability Application and Services
License. Subject to your compliance with these Terms and solely for so long as you are permitted by us to access and use the pliability Application and Service, pliability grants you a limited, non-transferable, non-exclusive, revocable right and license to access and use the pliability Application and Service for your own personal, non-commercial purposes, a right which may not be assigned or sublicensed to anyone. This license includes the right to view Content (defined below) available on the pliability Application and Service and the right to download one copy of the Application to any single device for your personal, non-commercial use only, provided you keep intact all copyright and other proprietary notices. This license will remain in effect unless and until you violate these Terms, or this license is terminated by you or pliability.
